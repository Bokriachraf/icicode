    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 py-16">
      {loading ? (
        ...
        >
          ...
          <p className="text-center text-[0.65rem] tracking-[0.3em] uppercase mb-8" style={{ color: 'var(--text-muted)' }}>
          ...
          <form onSubmit={submitHandler}>
            ...
            {error && (
              <div className="px-4 py-2.5 rounded-lg mb-5 text-sm border" style={{ background: 'rgba(255,80,80,0.08)', borderColor: 'rgba(255,80,80,0.3)', color: '#FF8A8A' }}>
                {error}
              </div>
            )}
            ...
            <div className="mb-6">
              ...
              <input
                ...
                value={password} required className={inputClass}
            ...
            <div className="mt-6 text-sm text-center" style={{ color: 'var(--text-secondary)' }}>
              Nouveau client ?{' '}
              <Link href={`/register?redirect=${redirect}`} className="font-medium hover:underline" style={{ color: 'var(--brand-cyan)' }}>
                Créez un compte
              </Link>
            </div>
          </form>
